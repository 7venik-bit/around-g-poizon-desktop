...
test("v2.10.378 release metadata is synchronized", () => {
  assert.equal(pkg.version, "2.10.378");
  assert.equal(lock.version, "2.10.378");
  assert.equal(lock.packages[""].version, "2.10.378");
});
