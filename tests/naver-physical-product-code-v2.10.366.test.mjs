...
test("v2.10.375 release metadata is synchronized", () => {
  assert.equal(pkg.version, "2.10.375");
  assert.equal(lock.version, "2.10.375");
  assert.equal(lock.packages[""].version, "2.10.375");
});
