...
test("release metadata is 2.10.255", () => {
  assert.equal(JSON.parse(packageSource).version, "2.10.255");
  assert.equal(JSON.parse(lockSource).version, "2.10.255");
  assert.equal(JSON.parse(lockSource).packages[""].version, "2.10.255");
});
