...
contextBridge.exposeInMainWorld("aroundG", {
  ...
  clearLedgerWorkbookCells: (input) => ipcRenderer.invoke('ledger:workbook-clear', input),
  copyLedgerWorkbookCells: (input) => ipcRenderer.invoke('ledger:workbook-copy', input),
