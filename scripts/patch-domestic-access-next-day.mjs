...
const activityFunctionMarker = cancelableFunctionMarker.replace(
  "generation = domesticSearchGeneration)", "generation = domesticSearchGeneration, onActivity = null)",
);
const functionMarker = main.includes(activityFunctionMarker) ? activityFunctionMarker
  : main.includes(cancelableFunctionMarker) ? cancelableFunctionMarker : legacyFunctionMarker;
