...
const functionMarker = "async function renderedSearchSourceResult(source, articleNumber, brand = \"\", title = \"\", securityRetry = 0, searchAttempt = null, sharedNaverSession = null) {";
...
main = replaceOnce(
  ...
  "skip blocked mall until next day",
);
