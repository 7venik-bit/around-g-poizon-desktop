...
sourcing = replaceOnce(
  ...
  "      const sourcingRenderer = function sourcingRenderExcelProductRows(file, products = []) {\n        try {\n          products = highestQualifiedSizeRows(products);",
  "filter product rows to highest qualified size price",
);
sourcing = replaceOnce(
  sourcing,
...
console.log("domestic stock-search disabled and highest qualified size-price sourcing enabled");
