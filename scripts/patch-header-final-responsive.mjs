...
for (const required of [
  marker,
  "#official-domain-audit-toggle::after{content:'공식몰'",
  "#weekly-site-health-run::after{content:'서버'",
  "#startup-recovery-run::after{content:'POIZON'",
  "#brand-export-folder-select::after{content:'저장'",
  '#app-version-state{display:none!important}',
  'flex-wrap:nowrap!important',
  'font-size:clamp(9px,.66vw,11px)!important'
]) {
