...
`;
  ...
  writeFileSync(join(appDir,'package.json'),JSON.stringify({name:'around-g-live-retailer-audit',version:'2.10.745-audit',type:'module',main:'../scripts/.live-retailer-entry.mjs'}));
} catch(error) {
